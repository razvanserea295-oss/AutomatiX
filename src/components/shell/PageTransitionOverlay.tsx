...
export default function PageTransitionOverlay({ routeKey }: Props) {
  ...
  return (
    <div
      aria-hidden
      className={`pointer-events-none absolute inset-0 z-20 flex items-center justify-center bg-surface-primary transition-opacity duration-150 motion-reduce:hidden ${
