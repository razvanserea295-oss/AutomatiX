...
import { DESKTOP_PAGE_FIT, PAGE_GAP } from '@/v2/components/layout/constants';
...
function Page({ fit = false, layout = 'col', children, className = '', ...rest }: PageProps) {
  const fitCls = fit ? DESKTOP_PAGE_FIT : 'flex w-full flex-1 flex-col min-h-0 min-w-0 overflow-y-auto';
  return (
    <div
