...
import Page from '@/v2/components/primitives/Page';
import PageToolbar from './PageToolbar';
import { DESKTOP_BODY_FIT, DESKTOP_FOOTER_BAND, PAGE_CONTENT_SHELL, PAGE_GAP } from './constants';
  ...
  return (
    <Page fit>
      ...
      <Page.Body
        ...
        maxWidth="full"
        padding="comfortable"
        className={`page-body-polish ${DESKTOP_BODY_FIT} ${PAGE_GAP} ${bodyClassName}`}
      >
