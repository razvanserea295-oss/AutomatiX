...
/** Desktop viewport-fit chain — mobile page scroll, lg+ no page scroll. */
export const DESKTOP_PAGE_FIT = 'flex w-full flex-1 flex-col min-h-0 min-w-0 h-full overflow-y-auto lg:overflow-hidden';
export const DESKTOP_BODY_FIT = 'flex w-full flex-col lg:flex-1 lg:min-h-0 lg:overflow-hidden';
export const DESKTOP_CONTENT_GROW = 'flex w-full flex-col lg:flex-1 lg:min-h-0 lg:overflow-hidden';
export const DESKTOP_GRID_FILL = 'grid w-full lg:flex-1 lg:min-h-0 lg:overflow-hidden';
...
/** Top-aligned loading / empty placeholder inside fill panels */
export const PANEL_LOADING = 'flex w-full flex-col items-center justify-start gap-2 px-6 py-10 text-center text-content-muted';
export const PANEL_PLACEHOLDER = 'flex w-full flex-col items-center justify-start gap-2 px-6 py-10 text-center';
